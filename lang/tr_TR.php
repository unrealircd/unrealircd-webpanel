...
return [
	...
	'menu_logout' => 'Çıkış',
	'menu_settings' => 'Panel Ayarlar',
	'menu_accounts' => 'Hesaplar',
	'menu_role_editor' => 'Rol Düzenleyici',
	...
	// Other
	'other_base_url' => 'Config dosyanızda base_url bulunamadı. Kurulum yanlış mı yapıldı?',
	'other_auth_provided' => 'Hiçbir kimlik doğrulama eklentisi yüklenmedi. sql_db, file_db veya benzeri bir kimlik doğrulama eklentisi yüklemelisiniz!',
	'die_vendor' => 'vendor/ dizini eksik. Muhtemelen yönetici "composer install" komutunu çalıştırmayı unuttu.',
	'access_denied' => 'Erişim reddedildi',
	'rpc_serverconfigured_fail' => 'Hiçbir RPC sunucusu yapılandırılmamış. Ayarlar - RPC Sunucuları bölümüne gidin.',
	'rpc_serverconfigured_credentials' => 'RPC Sunucusu için kimlik bilgileri eksik',
	'rpc_serverconfigured_config' => 'Veritabanınızdaki RPC şifresi, config/config.php dosyasındaki anahtardan farklı bir anahtarla şifrelendi.<br>
	Lütfen eski config/config.php dosyanızı geri yükleyin veya temiz bir veritabanıyla başlayın.<br>',
	'rpc_serverconfigured_nounrealircd' =>
    'UnrealIRCd\'ye bağlanılamıyor: %s<br>' .
    'Ayarlar - RPC Sunucuları bölümündeki bağlantı bilgilerinin UnrealIRCd ile eşleştiğini doğrulayın,<br>' .
    've UnrealIRCd\'nin çalışır durumda olduğundan emin olun.',
	'dcdq_ban_reason' => 'Bu kanaldan çıkarıldınız.',
