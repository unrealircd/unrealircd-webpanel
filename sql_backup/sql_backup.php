...
/*
    ...
    And it creates the following SQL tables:
        ...
        - unreal_irc_servers, equivalent to the anope_server table
        - unreal_irc_name_bans (not exist on anope)
...
require_once "tables/unreal_irc_users.php";
require_once "tables/unreal_irc_channels.php";
require_once "tables/unreal_irc_spamfilter.php";
require_once "tables/unreal_irc_servers.php";
require_once "tables/unreal_irc_name_bans.php";
